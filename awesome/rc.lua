...
globalkeys = mytable.join(
 ...
 --       end,
    ...
    awful.util.spawn("java -jar /home/rohan/Desktop/Games/TLauncher-2.8.jar") end,
    {description = "tlauncher", group = "application"}),
    ...
    {description = "atom", group = "application"}),

    -- Ungoogled Chromium
    awful.key({modkey}, "c", function ()
    awful.util.spawn("flatpak run com.github.Eloston.UngoogledChromium") end,
    {description = "Chromium without Google", group = "browser"}),
